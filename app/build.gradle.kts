...
android {
    namespace = "br.edu.satc.treasurehunt"
    compileSdk = 34

    defaultConfig {
        applicationId = "br.edu.satc.treasurehunt"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
...
// Navigation circular dependency fix: excluding ktx modules directly in the implementation block
